...
public class EditarPerfilActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editarNombre = (EditText)findViewById(R.id.et_nombre_editarPerfil);
        editarApellidos = (EditText)findViewById(R.id.et_apellidos_editarPerfil);
        editarLocalidad = (Spinner)findViewById(R.id.spinner_provincias_editarPerfil);
        ...
        adapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.provincias));
        ...
        aceptar = (Button)findViewById(R.id.btn_guardar_editarPerfil);
